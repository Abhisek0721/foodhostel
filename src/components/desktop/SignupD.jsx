        ...
        try {
            axios.post("/signup",{
                ...
                if(res.data.msg){
                    ...
                    return navigate('/verify', { state : {phoneNum:value} });
                }
            })
        } catch (error) {
            ...
            <form method="post" onSubmit={userSubmit}>
                <div className='mt-10 lg:w-[40%] lg:mx-auto'>
                    ...
                    <p className='text-sm font-mono my-5'>
                        ...
                        <label htmlFor="agreement" className='m-3'>I agree to Foodime's <a href="#" className='text-red-700 ml-2'>Terms of Service</a> and <a href="#" className='text-red-700 ml-2'>Privacy Policy</a>.</label>
                    </p>
